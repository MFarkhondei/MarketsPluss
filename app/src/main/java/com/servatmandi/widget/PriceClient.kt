 ...
 * شناسه‌های Entity ثروتمندی برای مرجع:
 *  دلار 100000000001 | طلا۱۸ 5000000001102 | انس 10000000001901
 *  سکه امامی 5000000001202 | BTC 920000 | ETH 920001
 *  شاخص کل 32097828799138957 | عیار 34144395039913458 | موج 67141987086032267
 */
object PriceClient {
    ...
    fun fetchSnapshot(): MarketSnapshot {
        ...
        // دلار آزاد: در TGJU به ریال است → تومان = /10
        val dollarRial = price("price_dollar_rl")
        val dollarToman = dollarRial / 10.0
        val dollarChg = change("price_dollar_rl")

        // طلا ۱۸ عیار (ریال → تومان)
        val gold18Rial = price("geram18")
        val gold18Toman = gold18Rial / 10.0
        ...
        // سکه امامی (ریال → تومان)
        val sekeeRial = price("sekee")
        val sekeeToman = sekeeRial / 10.0
        ...
        val items = listOf(
            ...
            MarketItem("عیار", ayar, ayarChg, "تومان"),
            ...
            MarketItem("موج", moj, mojChg, "تومان")
        )
    ...
    private fun httpGet(urlStr: String): String {
        ...
        while (redirects < 5) {
            val conn = (URL(current).openConnection() as HttpURLConnection).apply {
                ...
                readTimeout = 25000
                requestMethod = "GET"
                setRequestProperty("User-Agent", "ServatmandiWidget/1.0")
